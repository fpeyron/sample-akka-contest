...
import fr.sysf.sample.actors.ParticipationActor.{ParticipateCmd, ParticipationEvent}
import fr.sysf.sample.models.InstantwinDomain.InstantwinExtended
import fr.sysf.sample.models.ParticipationDto.{ParticipateResponse, ParticipationStatusType}
import fr.sysf.sample.models.PrizeDao.PrizeResponse
